...
<head>
    ...
    <meta name="description"
        content="Discover the best halal and kosher meat, food and grocery stores near you. GoFeast provides same day delivery to your doorstep from your favorite local stores">
        
    
    <title>Order Food & Grocery Online | GoFeast Home Delivery | Same Day Delivery </title>
</head>

<!-- TODO explore -> paertner with us
TOD -->

<body>

    <?php include'home-banner.html'?>
                ...
                <div class="row gx-lg-8 gx-xl-10 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row gy-6 gx-xxl-8 process-wrapper">
                            <div class="col-md-4"> <img src="./assets/img/icons/lineal/cloud-computing.svg"
                            ...
                            <div class="col-md-4"> <img src="./assets/img/icons/lineal/smartphone-2.svg"
                            ...
                            <div class="col-md-4"> <img src="./assets/img/icons/lineal/rocket.svg"
    ...
    <!--<a href="https://gofeast.page.link/N9CY">click</a>-->
