                    ...
                    <div class="col-lg-6">
                        <div class="row g-6 text-center">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <figure class="rounded mb-6"><img src="./assets/img/photos/drivertop.png"
                                                alt=""></figure>
                                    </div>
                                    <!-- /column -->
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 order-md-2 ">
                                        <figure class="rounded mb-6 mb-md-0"><img
                                                src="./assets/img/photos/driverbottom.png" alt=""></figure>
                                    </div>
                                    <!-- /column -->
                                    <div class="col-lg-12">
        ...
        <section class="wrapper bg-light ">
            ...
            <div class="container py-10 py-md-10">
                <div class="row gx-lg-8 gx-xl-12 gy-10  align-items-center" data-cues="slideInDown"
                    ...
                    <div class="col-lg-7">
                        <figure><img class="w-auto" src="./assets/img/photos/driver-contact.png" alt="" /></figure>
                    </div>
                </div>
