...
<head>
    ...
    <meta name="description"
        content="Sign up to deliver food and groceries in the USA. Flexible timings. Work from anywhere. Highest payout in the field. Keep 100% of your tips.">

    
    <title>Delivery Food & Earn extra cash | GoFeast Driver | Apply Now!</title>
                    ...
                    <div class="col-lg-6">
                        <div class="row g-6 text-center">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <figure class="rounded mb-6"><img src="./assets/img/photos/gofeast_images/drivertop.png"
                                                alt=""></figure>
                                    </div>
                                    <!-- /column -->
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 order-md-2 ">
                                        <figure class="rounded mb-6 mb-md-0"><img
                                                src="./assets/img/photos/gofeast_images/driverbottom.png" alt=""></figure>
                                    </div>
                                    <!-- /column -->
                                    <div class="col-lg-12">
                ...
                <div class="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0">
                    ...
                    <div class="col-lg-8 mt-lg-2">
                        <div class="row align-items-center counter-wrapper gy-6 text-center">
                            ...
                            <!--/column -->
                            <div class="col-md-4">
                                <img src="./assets/img/icons/lineal/coin.svg"
                                    class="svg-inject icon-svg solid-mono text-primary  mb-3" alt="" />
        ...
        <section class="wrapper bg-light ">
            ...
            <div class="container py-10 py-md-10">
                <div class="row gx-lg-8 gx-xl-12 gy-10  align-items-center" data-cues="slideInDown"
                    ...
                    <div class="col-lg-7">
                        <figure><img class="w-auto" src="./assets/img/photos/gofeast_images/driver-contact.png" alt="" /></figure>
                    </div>
                </div>
