                        ...
                        <div class="row gx-md-5 gy-5">
                            <div class="col-md-5 offset-md-1 align-self-end">
                                <div class="card bg-pale-yellow">
                                    <div class="card-body">
                                        <img src="./assets/img/photos/increase-rev.png" width="150" height="auto"
                                            class="mb-3" alt="" />
                            ...
                            <div class="col-md-6 align-self-end">
                                <div class="card bg-pale-red">
                                    <div class="card-body">
                                        <img src="./assets/img/photos/no-setup-cost.png" width="150" height="auto"
                                            class="mb-3" alt="" />
                                        <!-- <h4>No Setup Cost</h4> -->
                            ...
                            <div class="col-md-5">
                                <div class="card bg-pale-leaf">
                                    <div class="card-body">
                                        <img src="./assets/img/photos/marketing.png" width="150" height="auto"
                                            class="mb-3" alt="" />
                            ...
                            <div class="col-md-6 align-self-start">
                                <div class="card bg-pale-primary">
                                    <div class="card-body">
                                        <img src="./assets/img/photos/home-delivery.png" width="150" height="auto"
                                            class="mb-3" alt="" />
                            ...
                            <div class="col-md-6">
                                <div class="row gx-md-5 gy-5">
                                    <div class="col-md-10 offset-md-2">
                                        <figure class="rounded"><img src="./assets/img/photos/order-placed.png" alt="">
                                        </figure>
                                    </div>
                                    <!--/column -->
                                    <div class="col-md-12">
                                        <figure class="rounded"><img src="./assets/img/photos/order-prepration.png"
                                                alt=""></figure>
                                    </div>
                                    <!--/column -->
                                </div>
        ...
        <section class="wrapper bg-light ">
            ...
            <div class="container py-10 py-md-10">
                ...
                <div class="row gx-lg-8 gx-xl-12 gy-10 mt-2  align-items-center" data-cues="slideInDown"
                    data-group="process">
                    <div class="col-lg-7">
                        <figure><img class="w-auto" src="./assets/img/photos/store-contact.png" alt="" /></figure>
                    </div>
