...
<head>
    ...
    <meta name="description"
        content="Sign up and become a part of the only halal and kosher marketplace. Reach out to new customers, enable same-day delivery, create your online presence.">
        
    
    <title>GoFeast Partner | Apply Now!</title>
                        ...
                        <div class="row gx-md-5 gy-5">
                            <div class="col-md-5 offset-md-1 align-self-end">
                                <div class="card bg-pale-yellow">
                                    <div class="card-body">
                                        <img src="./assets/img/photos/gofeast_images/increase-rev.png" width="150" height="auto"
                                            class="mb-3" alt="" />
                            ...
                            <div class="col-md-6 align-self-end">
                                <div class="card bg-pale-red">
                                    <div class="card-body">
                                        <img src="./assets/img/photos/gofeast_images/no-setup-cost.png" width="150" height="auto"
                                            class="mb-3" alt="" />
                                        <!-- <h4>No Setup Cost</h4> -->
                            ...
                            <div class="col-md-5">
                                <div class="card bg-pale-leaf">
                                    <div class="card-body">
                                        <img src="./assets/img/photos/gofeast_images/marketing.png" width="150" height="auto"
                                            class="mb-3" alt="" />
                            ...
                            <div class="col-md-6 align-self-start">
                                <div class="card bg-pale-primary">
                                    <div class="card-body">
                                        <img src="./assets/img/photos/gofeast_images/home-delivery.png" width="150" height="auto"
                                            class="mb-3" alt="" />
                            ...
                            <div class="col-md-6">
                                <div class="row gx-md-5 gy-5">
                                    <div class="col-md-10 offset-md-2">
                                        <figure class="rounded"><img src="./assets/img/photos/gofeast_images/order-placed.png" alt="">
                                        </figure>
                                    </div>
                                    <!--/column -->
                                    <div class="col-md-12">
                                        <figure class="rounded"><img src="./assets/img/photos/gofeast_images/order-prepration.png"
                                                alt=""></figure>
                                    </div>
                                    <!--/column -->
                                </div>
        ...
        <section class="wrapper bg-light ">
            ...
            <div class="container py-10 py-md-10">
                ...
                <div class="row gx-lg-8 gx-xl-12 gy-10 mt-2  align-items-center" data-cues="slideInDown"
                    data-group="process">
                    <div class="col-lg-7">
                        <figure><img class="w-auto" src="./assets/img/photos/gofeast_images/store-contact.png" alt="" /></figure>
                    </div>
